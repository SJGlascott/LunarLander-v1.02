...
Public Class LanderServer
    ...
    Dim pointsSent As Boolean = False
    ...
    End Sub
    'This sub simply sends pathpoints to the client
    Private Sub sendPathPointArray(ByRef array() As Point)
        Dim sendpoints As String = ""

        For i As Integer = 0 To pathPoints.Length - 1
            Dim temp As String = sendpoints
            sendpoints = temp & pathPoints(i).ToString & "SPLIT"
        Next

        If sendpoints IsNot "" Then
            Dim sendBytes() As Byte
            sendBytes = System.Text.Encoding.ASCII.GetBytes(sendpoints)
    ...
    Private Sub TimerRec_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles timerRec.Tick
        ...
        Dim sendBytes() As Byte
        sendBytes = System.Text.Encoding.ASCII.GetBytes(landerLocation.X.ToString & " " & landerLocation.Y.ToString & " " & angle & " " & sendCrashed & " " & sendThursting)
        TCPServer.Send(sendBytes)
